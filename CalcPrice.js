...
// Находим все радиокнопки на странице с атрибутом name, начинающимся с "radioGroup_"
var allRadioInputs = document.querySelectorAll('input[type="radio"][name^="radioGroup_"]');

// Добавляем слушателя события "change" для каждой радиокнопки
allRadioInputs.forEach(function (input) {
    ...
    setTimeout(updateTotalPrice, 600);
});
