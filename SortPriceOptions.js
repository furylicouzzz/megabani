  $(document).ready(function () {
    ...
    $('.parametrs-content-items').each(function () {
      ...
      var priceElements = currentGroup.find('.radio-button-field-2 .options-name-price-value, .checkbox-button-field-2 .options-name-price-value');
      ...
      priceElements.each(function() {
        dynList.append($(this).closest('.radio-list-items, .checkbox-list-items'));
      });
    });
  });
